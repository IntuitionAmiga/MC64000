    ...
    @def MATRIX_SIZE 4
    @def SIZE_BYTES 32
    @def STACK_BUFFER -40(sp) ; Room for one matrix and the return address of the verify call
...
.test_group_header:
    dc.b    "Testing mat2x2d operations...\n\0"

.test_identity_header:
    dc.b    "\tmat2x2d_identity: (r8) = I \0"

.test_copy_header:
    dc.b    "\tmat2x2d_copy: (r9) = (r8) \0"

.test_scale_assign_header:
    dc.b    "\tmat2x2d_scale_assign: (r8) *= fp0 \0"

.test_scale_header:
    dc.b    "\tmat2x2d_scale: (r9) = fp0 * (r8) \0"

.test_add_assign_header:
    dc.b    "\tmat2x2d_add_assign: (r9) += (r8) \0"

.test_add_header:
    dc.b    "\tmat2x2d_add: (r10) = (r9) + (r8) \0"

.test_sub_assign_header:
    dc.b    "\tmat2x2d_sub_assign: (r9) -= (r8) \0"

.test_sub_header:
    dc.b    "\tmat2x2d_sub: (r10) = (r9) - (r8) \0"

.test_mul_assign_header:
    dc.b    "\tmat2x2d_mul_assign: (r9) *= (r8) \0"

.test_mul_header:
    dc.b    "\tmat2x2d_mul: (r10) = (r9) * (r8) \0"

.test_trans_header:
    dc.b    "\tmat2x2d_trans: (r9) = T(r8) \0"

.test_det_header:
    dc.b    "\tmat2x2d_det: fp0 = det(r8) \0"

.test_inv_header:
    dc.b    "\tmat2x2d_inv: (r9) = inv(r8) \0"
