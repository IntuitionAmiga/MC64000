...
class IntegerDyadicBranch extends DyadicBranch {
    ...
    const OPCODES = [
        ...
        IControl::BLO_B => 'foldImmediateIsLessThan',
        IControl::BLO_W => 'foldImmediateIsLessThan',
        IControl::BLO_L => 'foldImmediateIsLessThan',
        IControl::BLO_Q => 'foldImmediateIsLessThan',
        IControl::BLS_B => 'foldImmediateIsLessOrEqual',
        IControl::BLS_W => 'foldImmediateIsLessOrEqual',
        IControl::BLS_L => 'foldImmediateIsLessOrEqual',
        IControl::BLS_Q => 'foldImmediateIsLessOrEqual',
        IControl::BHS_B => 'foldImmediateIsGreaterOrEqual',
        IControl::BHS_W => 'foldImmediateIsGreaterOrEqual',
        IControl::BHS_L => 'foldImmediateIsGreaterOrEqual',
        IControl::BHS_Q => 'foldImmediateIsGreaterOrEqual',
        IControl::BHI_B => 'foldImmediateIsGreaterThan',
        IControl::BHI_W => 'foldImmediateIsGreaterThan',
        IControl::BHI_L => 'foldImmediateIsGreaterThan',
        IControl::BHI_Q => 'foldImmediateIsGreaterThan',
    ];
