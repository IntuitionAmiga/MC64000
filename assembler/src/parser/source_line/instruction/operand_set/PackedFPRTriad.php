 ...
 */
class PackedFPRTriad extends Triadic {

    const OPCODES = [
        IArithmetic::R2R_FMACC_S,
        IArithmetic::R2R_FMACC_D,
    ];

    const MIN_OPERAND_COUNT = 3;
    ...
    public function __construct() {
        ...
        $this->oSrcParser  =
        $this->oDstParser  =
        $this->oSrc2Parser = new EffectiveAddress\FPRDirect();
    }
    ...
    public function parse(int $iOpcode, array $aOperands, array $aSizes = []): string {
        ...
        return chr($iSrc1Reg << 4 | $iDstReg) . chr($iSrc2Reg);
    }
