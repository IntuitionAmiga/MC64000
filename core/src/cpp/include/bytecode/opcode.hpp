...
enum Arithmetic {
    ...
    R2R_FMACC_S = OFS_ARITHMETIC + 31,
    R2R_FMACC_D = OFS_ARITHMETIC + 32,
    R2R_FMADD_S = OFS_ARITHMETIC + 33,
    R2R_FMADD_D = OFS_ARITHMETIC + 34,
    EXTB_W      = OFS_ARITHMETIC + 35,
    EXTB_L      = OFS_ARITHMETIC + 36,
    EXTB_Q      = OFS_ARITHMETIC + 37,
    EXTW_L      = OFS_ARITHMETIC + 38,
    EXTW_Q      = OFS_ARITHMETIC + 39,

    EXTL_Q      = OFS_ARITHMETIC + 40,
    ASL_B       = OFS_ARITHMETIC + 41,
    ASL_W       = OFS_ARITHMETIC + 42,
    ASL_L       = OFS_ARITHMETIC + 43,
    ASL_Q       = OFS_ARITHMETIC + 44,
    ASR_B       = OFS_ARITHMETIC + 45,
    ASR_W       = OFS_ARITHMETIC + 46,
    ASR_L       = OFS_ARITHMETIC + 47,
    ASR_Q       = OFS_ARITHMETIC + 48,
    ADD_B       = OFS_ARITHMETIC + 49,

    ADD_W       = OFS_ARITHMETIC + 50,
    ADD_L       = OFS_ARITHMETIC + 51,
    ADD_Q       = OFS_ARITHMETIC + 52,
    FADD_S      = OFS_ARITHMETIC + 53,
    FADD_D      = OFS_ARITHMETIC + 54,
    SUB_B       = OFS_ARITHMETIC + 55,
    SUB_W       = OFS_ARITHMETIC + 56,
    SUB_L       = OFS_ARITHMETIC + 57,
    SUB_Q       = OFS_ARITHMETIC + 58,
    FSUB_S      = OFS_ARITHMETIC + 59,

    FSUB_D      = OFS_ARITHMETIC + 60,
    NEG_B       = OFS_ARITHMETIC + 61,
    NEG_W       = OFS_ARITHMETIC + 62,
    NEG_L       = OFS_ARITHMETIC + 63,
    NEG_Q       = OFS_ARITHMETIC + 64,
    FNEG_S      = OFS_ARITHMETIC + 65,
    FNEG_D      = OFS_ARITHMETIC + 66,
    MULS_B      = OFS_ARITHMETIC + 67,
    MULS_W      = OFS_ARITHMETIC + 68,
    MULS_L      = OFS_ARITHMETIC + 69,

    MULS_Q      = OFS_ARITHMETIC + 70,
    MULU_B      = OFS_ARITHMETIC + 71,
    MULU_W      = OFS_ARITHMETIC + 72,
    MULU_L      = OFS_ARITHMETIC + 73,
    MULU_Q      = OFS_ARITHMETIC + 74,
    FMUL_S      = OFS_ARITHMETIC + 75,
    FMUL_D      = OFS_ARITHMETIC + 76,
    DIVS_L      = OFS_ARITHMETIC + 77,
    DIVS_Q      = OFS_ARITHMETIC + 78,
    MODS_L      = OFS_ARITHMETIC + 79,

    MODS_Q      = OFS_ARITHMETIC + 80,
    DIVU_L      = OFS_ARITHMETIC + 81,
    DIVU_Q      = OFS_ARITHMETIC + 82,
    MODU_L      = OFS_ARITHMETIC + 83,
    MODU_Q      = OFS_ARITHMETIC + 84,
    FDIV_S      = OFS_ARITHMETIC + 85,
    FDIV_D      = OFS_ARITHMETIC + 86,
    FMOD_S      = OFS_ARITHMETIC + 87,
    FMOD_D      = OFS_ARITHMETIC + 88,
    FABS_S      = OFS_ARITHMETIC + 89,

    FABS_D      = OFS_ARITHMETIC + 90,
    FSQRT_S     = OFS_ARITHMETIC + 91,
    FSQRT_D     = OFS_ARITHMETIC + 92,
    FACOS_S     = OFS_ARITHMETIC + 93,
    FACOS_D     = OFS_ARITHMETIC + 94,
    FASIN_S     = OFS_ARITHMETIC + 95,
    FASIN_D     = OFS_ARITHMETIC + 96,
    FATAN_S     = OFS_ARITHMETIC + 97,
    FATAN_D     = OFS_ARITHMETIC + 98,
    FCOS_S      = OFS_ARITHMETIC + 99,

    FCOS_D      = OFS_ARITHMETIC + 100,
    FSIN_S      = OFS_ARITHMETIC + 101,
    FSIN_D      = OFS_ARITHMETIC + 102,
    FSINCOS_S   = OFS_ARITHMETIC + 103,
    FSINCOS_D   = OFS_ARITHMETIC + 104,
    FTAN_S      = OFS_ARITHMETIC + 105,
    FTAN_D      = OFS_ARITHMETIC + 106,
    FETOX_S     = OFS_ARITHMETIC + 107,
    FETOX_D     = OFS_ARITHMETIC + 108,
    FLOGN_S     = OFS_ARITHMETIC + 109,

    FLOGN_D     = OFS_ARITHMETIC + 110,
    FLOG2_S     = OFS_ARITHMETIC + 111,
    FLOG2_D     = OFS_ARITHMETIC + 112,
    FTWOTOX_S   = OFS_ARITHMETIC + 113,
    FTWOTOX_D   = OFS_ARITHMETIC + 114
};
