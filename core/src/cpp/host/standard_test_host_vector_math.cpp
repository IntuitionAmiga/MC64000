...
Interpreter::Status hostVector(uint8 uFunctionID) {
    ...
    switch (iOperation) {
        ...
        case VEC2D_XFRM_2X2:        v2_transform_2x2(float64, Double);          break;
        case VEC2D_0_XFRM_3X3:      v2_0_transform_3x3(float64, Double);        break;
        case VEC2D_1_XFRM_3X3:      v2_1_transform_3x3(float64, Double);        break;
        case VEC2D_TO_VEC3F:        v2_expand_v3(float64, Double);              break;
        ...
        case VEC3D_XFRM_3X3:        v3_transform_3x3(float64, Double);          break;
